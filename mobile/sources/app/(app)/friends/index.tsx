...
export default function FriendsScreen() {
    ...
    const [acceptLoading, doAccept] = useZenfloAction(async () => {
    ...
    const [rejectLoading, doReject] = useZenfloAction(async () => {
        if (!credentials || !processingId) return;
    ...
    const [removeLoading, doRemove] = useZenfloAction(async () => {
        if (!credentials || !processingId) return;
