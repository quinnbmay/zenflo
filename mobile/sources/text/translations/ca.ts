...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        qwenAuthSuccess: 'Connexió amb Qwen realitzada amb èxit',
    ...
    agentInput: {
        ...
        ccrModel: {
            title: 'MODEL CCR',
            glm46: 'GLM-4.6 (Per defecte)',
            glm45Air: 'GLM-4.5 Air (Fons)',
        },
        context: {
    ...
    message: {
        ...
        agentRequiresReply: 'Aquest agent està esperant la teva resposta',
        typeYourReply: 'Escriu la teva resposta...',
    },
