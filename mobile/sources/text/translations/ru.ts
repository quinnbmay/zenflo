...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'О программе',
        aboutFooter: 'ZenFlo Coder — мобильное приложение для работы с Codex и Claude Code. Использует сквозное шифрование, все данные аккаунта хранятся только на вашем устройстве. Не связано с Anthropic.',
        whatsNew: 'Что нового',
        ...
        qwenAuthSuccess: 'Успешно подключено к Qwen',
    ...
    agentInput: {
        ...
        ccrModel: {
            title: 'МОДЕЛЬ CCR',
            glm46: 'GLM-4.6 (По умолчанию)',
            glm45Air: 'GLM-4.5 Air (Фоновый)',
        },
        context: {
    ...
    message: {
        ...
        agentRequiresReply: 'Этот агент ждет вашего ответа',
