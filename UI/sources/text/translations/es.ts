...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        qwenAuthSuccess: 'Conectado exitosamente con Qwen',
    ...
    agentInput: {
        ...
        ccrModel: {
            title: 'MODELO CCR',
            glm46: 'GLM-4.6 (Por defecto)',
            glm45Air: 'GLM-4.5 Air (Fondo)',
        },
        context: {
    ...
    settingsVoice: {
        ...
        languageTitle: 'Asistente de Voz Max',
    ...
    message: {
        ...
        agentRequiresReply: 'Este agente está esperando tu respuesta',
    ...
    zenVoice: {
        ...
        transcriptPlaceholder: 'Tu conversación aparecerá aquí...',
    }
} as const;
