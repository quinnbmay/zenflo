...
# Add DNS record for zen.combinedmemory.com
# This script uses your Cloudflare credentials to add a CNAME record

echo "Adding DNS record: zen.combinedmemory.com -> zen-mode-mcp.quinn-4b3.workers.dev"
...
if [ -z "$CF_API_TOKEN" ]; then
  ...
  echo "  - Zone:DNS:Edit for combinedmemory.com"
  echo ""
  echo "Then run:"
  ...
  echo "https://dash.cloudflare.com/4b339d9b82347caea48bbe42d4896bbd/combinedmemory.com/dns/records"
  echo ""
...
echo "  curl https://zen.combinedmemory.com/health"
